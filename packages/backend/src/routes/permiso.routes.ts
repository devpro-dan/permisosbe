...
router.get('/reporte/trabajadores', authorize('reportes', 'view'), permisoController.reporteResumenTrabajadores);
router.get('/reporte/trabajadores/pdf', authorize('reportes', 'view'), permisoController.reporteResumenTrabajadoresPDF);
